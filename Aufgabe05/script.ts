...
let cirrus: Artikel = { img: "pics/cirrus.jpg", name: "Cirruswolke", description: "Nice Wolke", price: 11.50  };
let cumulonimbus: Artikel = { img: "pics/cumulonimbus.jpg", name: "Cumulonimbuswolke", description: "Wenn du Gewitter magst, genau deine Wolke", price: 1100.00  };
let stratus: Artikel = { img: "pics/stratus.jpg", name: "Stratuswolke", description: "Ein 'Furtwangen Depression' Classic", price: 2.00 };
let nimbostratus: Artikel = { img: "pics/nimbostratus.jpg", name: "Nimbostratuswolke€", description: "Erzeugen lange anhaltenden Regen: Deutsche Landwirte küssen deine Augen.", price: 200.00  };
let altostratus: Artikel = { img: "pics/altostratus.jpg", name: "Altostratuswolke", description: "Absoluter Schmodder", price: 10.00 };
let cirrostratus: Artikel = { img: "pics/cirrostratus.jpg", name: "Cirrostratuswolke", description: "Fusion aus Cirrus und Stratus: Erzeugt (mit Glück) schöne Kreise", price: 50.00 };
//Array Bestseller
let bestsellerW=[cirrus, cumulonimbus, stratus, nimbostratus, altostratus, cirrostratus];

//Unkonventionelle Wolken
let kraftwerkabdampf: Artikel = { img: "pics/AKW.jpg", name: "Kraftwerkabdampf", description: "pfui", price: 777777777777.77 };
let lilawolken: Artikel = { img: "pics/lilawolken.jpg", name: "Lila Wolken", description: "30 Grad, du kühlst dein Kompf am Fensterglas", price: 0.01};
let aschewolke: Artikel = { img: "pics/vulkanausbruch.jpg", name: "Aschewolke", description: "Abriss", price: 1.50};
//Array Unkonventionelle
let unkonventionelleW=[kraftwerkabdampf, lilawolken, aschewolke];

//Special Wolken
let wolke7: Artikel = { img: "pics/wolke7.jpg", name: "Wolke7", description: "Die wahre Liebe", price: 696969.69};
let andereWolke: Artikel = { img: "pics/daweeeeeeeed.jpg", name: "Diese andere Wolke", description: "gas gas", price: 4.20};
let icloud: Artikel = { img: "pics/icloud.jpg", name: "iCloud Speicher", description: "scameriono", price: 1111.10};
//Array Specials
